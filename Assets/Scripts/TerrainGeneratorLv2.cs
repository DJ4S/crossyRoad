...
public class TerrainGeneratorLv2 : MonoBehaviour
{
    ...
    [HideInInspector] public Vector3 currentPosition = new Vector3(0,0,0); // posicion donde generar el proximo terreno    private int lastIndex = -1;
